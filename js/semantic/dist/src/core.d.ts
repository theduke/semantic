...
export declare type IdOrIdent = Id | string;
...
export declare type Value = null | boolean | number | string | Value[] | {
...
export declare type UnaryOp = "Not";
export declare type BinaryOp = "And" | "Or" | "Eq" | "Neq" | "Gt" | "Gte" | "Lt" | "Lte" | "In" | "Contains" | "RegexMatch" | "RegexMatchCaseInsensitive";
...
export declare type Cardinality = "Optional" | "Required";
...
export declare type ValueType = "Any" | "Unit" | "Bool" | "Int" | "UInt" | "Float" | "String" | "Bytes" | {
    List: ValueType;
} | {
    Map: MapType;
} | {
...
export declare type Patch = Array<PatchOp>;
export declare type PatchPath = Array<PatchPathElem>;
export declare type PatchPathElem = {
    Key: string;
} | {
    ListIndex: number;
};
export declare type PatchOp = {
    Add: {
        path: PatchPath;
        value: Value;
    };
...
export declare type AggregationOp = "Count";
...
export declare type MutateSelectAction = "Delete" | {
    Patch: Patch;
};
...
export declare type ApiResponse<T = Reply> = {
    Ok: T;
} | {
    Err: ApiError;
};
...
export declare type DbConfig = "InMemory" | {
