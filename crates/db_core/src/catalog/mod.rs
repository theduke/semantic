...
pub use catalog::{
    ...
    OBJECT_TYPE_INDEX_NAME, PARENT_RELATION_ATTRIBUTE, PARENT_RELATION_ATTRIBUTE_ID,
    PARENT_RELATION_FIELD, PRIMARY_ID_FIELD, PRIMARY_ID_INDEX_NAME, RELATION_CLASS_ID,
    RELATION_FROM_ATTRIBUTE, RELATION_FROM_ATTRIBUTE_ID, RELATION_RELATION_ATTRIBUTE_ID,
    RELATION_TO_ATTRIBUTE, RELATION_TO_ATTRIBUTE_ID,
};
