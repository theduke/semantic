...
export const SEMANTIC_PREVIEW_IMAGE_BLOB_URI =
  'semantic/preview_image_blob_uri';
...
export const SEMANTIC_SOCIAL_MEDIA_PLATFORM_NAME =
  'semantic/social_media_platform_name';
export const SEMANTIC_SOCIAL_MEDIA_PLATFORM_ID =
  'semantic/social_media_platform_id';
...
export const SEMANTIC_IMPORT_URL_MAPPING_SOURCE_URL =
  'semantic.import_url_mapping/source_url';
export const SEMANTIC_IMPORT_URL_MAPPING_TARGET_URL =
  'semantic.import_url_mapping/target_url';
...
export interface SemanticSocialMediaAccount
  extends Omit<SemanticPerson, 'factor/type'> {
