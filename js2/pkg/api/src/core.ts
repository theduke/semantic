...
export interface Class {
  ...
  'factor/title': string | null;
  'factor/description': string | null;
  'factor/entityAttributes': Array<ClassAttribute>;
  'factor/extend': Array<string>;
  'factor/isStrict': boolean;
}

export interface ClassAttribute {
  'factor/attribute': string;
  'factor/required': boolean;
}
...
export interface ImportRawReply {
